    ...
    return (
        <section className="pb-24 pt-40">
            <div className="min-h-full flex items-center justify-center px-4 sm:py-24 md:grid md:place-items-center">
                <div className="max-w-max flex justify-center items-center mx-auto">
                    <main className="sm:flex">
                        ...
                        <div className="sm:ml-6">
                            ...
                            <button
                            className="h-12 px-12 mt-7 bg-black dark:bg-white rounded-sm text-white dark:text-black lg:ml-6"
                            >
